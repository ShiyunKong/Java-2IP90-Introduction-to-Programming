 ...
 * It iterates through the string and generates all possible substrings using nested loops. 
    ...
    */
    void run() {
        ...
        if (radius1 < 0 || radius2 < 0) {
            ...
            final double distanceFromCenter2 = Math.sqrt(xDistanceFromCenter2 
                * xDistanceFromCenter2 + yDistanceFromCenter2 * yDistanceFromCenter2);
